...
\end{description}
Of the three documents, only the last, \ttt{Service Specification}, is to be used to describe specifications of the service, and as such only this will be studied closer at this time.
...
\begin{figure}[h]
  ...
  \end{tabular}
  \caption{Example of correct use of the solution through instant verification.}
...
\begin{figure}[h]
  ...
  \end{tabular}
  \caption{Example of correct use of the solution through non-instant verification.}
...
\begin{figure}[h]
  \begin{tabular}{L{2cm}|L{10cm}} \toprule
    ...
    Basic Flow & \makecell[l]{1. SD will submit a service specification.\\
                              2. SD submits all information as per the old service\\
                              \ \ \ \ specification syntax.\\
                              3. SD submits all information to a simple dummy model. \\
                              4. Model concept is tested and verified.\\
                              5. SD submits the service instance specification.}  \\ \bottomrule
  \end{tabular}

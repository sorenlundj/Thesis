...
\begin{itemize}
	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}
			...
			\draw	(2,0) -- (2,1) node[anchor=north west]	{$M_2$};
			\draw	(3,0) -- (3,2) node[anchor=north west]	{$M_3$};
			\draw	(4,0) -- (4,3) node[anchor=north west]	{$M_4$};
			\draw	(5,0) -- (5,3) node[anchor=west]		{$M_5$};

...
The functionality of the automatic implementation is built to directly utilize the manual model building module, and thus their functionalities are near identical. The only limited by the functionality of the parser and interpreter's ability to feed instructions to \ttt{mmods.erl}, such as the example given in Section \ref{ssec:Testing the Automatic Model Creator}.

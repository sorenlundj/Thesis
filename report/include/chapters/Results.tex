...
\begin{description}
  ...
  \item[{bad\_connection\_to/0}]\ \\
    This test case works similar to \ttt{bad\_connection\_from/0}, however, in this case, the connection from \ttt{Serv} to \ttt{Comp} is missing. Thus, \ttt{Serv} finds none to pass the request on, and thus no ships receive information.

...
%TODO Hvis det fungerer med interpreter(parser(xml))=model, så skriv det på.
...
\begin{description}
	...
	\item[Dependency]\ \\
	XXXXX %TODO Er der her tale om dependencies fra andre entities, eller er det mere 'miljøvariabler?'
\end{description}

% Snak om de forskællige nye attributter: entities, relations, dependencies og så videre
...
% Hvordan skal dette implementeres/BRUGES i MCP (ikke teknisk)

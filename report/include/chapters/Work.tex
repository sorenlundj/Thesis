...
%As described in Chapter \ref{chp:Analysis}, the choice between the two model creation techniques plays a vital %role in the utilization hereof. 
...
\begin{figure}[h]
    ...
    \node (AD)  at (1,6) {\lstinline{add_dependency/3}};
    \node (RI)  at (6,6) {\lstinline{remove_info/2}};
    \node (TI)  at (9,6) {\lstinline{transfer_info/3}};
    \node (Req) at (4,4) {\lstinline{request_info/4}};

...
\renewcommand{\hline}[1]{\Xhline{#1\arrayrulewidth}}

\newcommand{\refNumName}[1]{\ref{#1}: \nameref{#1}}
\newcommand{\fitToPage}[1]{\resizebox{\linewidth}{!}{#1}}
...
% Til vejledning?
%
% Har jeg nok i forhold til hvor mange emner jeg har skrevet om?
% Work er ikke færdig, men den fylder ikke så meget
%
%
%
